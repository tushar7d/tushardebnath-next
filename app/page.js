      ...
      >
        ...
        <section className="home-content-section ">
          <div className="flex items-center justify-between p-6 mb-4 bg-blue-100 rounded-2xl ">
            <div>
              <h2 className="mb-2 font-serif text-4xl ">I am Tushar Debnath</h2>
              <div className="w-3/4 text-xl font-light text-left ">
                a product designer, developer, and writer from New Delhi. I am
                currently working with <a>Revolut</a> as part of the Expansion
                team.
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-6 mb-4 bg-green-100 rounded-2xl ">
            <div>
              ...
              <div className="w-3/4 text-xl font-light text-left ">
                ...
                compelling products and systems used by millions of people around the globe.
