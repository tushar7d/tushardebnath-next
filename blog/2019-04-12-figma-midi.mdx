...
date: "April 12, 2019"
description: Step by step guide to setup a dedicated figma shortcut machine.
tags: ["figma", "tooling"]
---
...
[](https://apps.apple.com/us/app/midi-loupe/id507075182?mt=12)
...
_Protip: you can find the panel in the help menu or by using the shortcut key_
...
**Step 3  
**This is the most important step. This is where I will show you how to set up midi stroke to send keyboard shortcuts to Figma (_Pro tip: or any app_  )
...
Once you have done this open Figma and see the magic! Rinse and  _repeat step 3_ until all your keys are mapped and you are done.
